...
export default function MemoryCard({ memory, onClick }) {
  return (
    <button onClick={onClick} className="card group relative block w-full overflow-hidden text-left">
      <div className="relative aspect-[4/3] w-full overflow-hidden bg-terracotta-100 dark:bg-terracotta-900/30">
        <img
